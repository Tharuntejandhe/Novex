...
///
/// Privacy: like the rest of Novex this only ever reads the local Mail store.
...
public final class MoneyRadarService {
    ...
    /// Realistic fake subscriptions for marketing screenshots (NOVEX_DEMO_MODE).
    ...
    public func scan() async {
        ...
        if UserDefaults.standard.bool(forKey: "NOVEX_DEMO_MODE") {
