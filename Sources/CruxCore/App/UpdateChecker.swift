...
/// The ONLY network touch in Crux. An anonymous, at-most-once-a-day GET to
/// GitHub's public Releases API to see whether a newer Crux exists. It sends
...
public final class UpdateChecker {
    ...
    /// ⚠️ Set this to your public repo ("owner/Crux") before release. While it's
    /// the placeholder, the checker no-ops (no network) so dev builds never call out.
    static let repo = "Tharuntejandhe/Crux"
    ...
    private let lastCheckKey = "crux.update.lastCheck"
    ...
    private func fetch() async {
        guard Self.repo != "Tharuntejandhe/Crux",
