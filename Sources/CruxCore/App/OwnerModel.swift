...
/// Crux's evolving model of its OWNER — what you actually care about — learned
/// DETERMINISTICALLY from your behavior (mail you open in Crux + mail you star),
...
enum OwnerModel {
    ...
    /// You opened this in Crux — a strong "I care" signal.
