...
/// One-time first-run experience. Explains what Crux does, that everything
...
struct OnboardingView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            // The trust message — the whole point of Crux.
            point(
            ...
            point(
                ...
                detail: "Crux needs Full Disk Access to read Mail's local store. It never modifies or sends anything."
            )
            point(
                icon: "mic.fill",
            ...
            Text("Tip: after enabling Full Disk Access, Crux updates automatically.")
                .font(.system(size: 10))
